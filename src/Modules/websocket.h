...
namespace Module
{
    namespace websocket
    {
        ...
        {
			public:
				Connection(const Module::request& req, Adaptor&& adaptor, 
						std::function<void(Module::websocket::connection&)> open_handler,
						std::function<void(Module::websocket::connection&, const std::string&, bool)> message_handler,
						std::function<void(Module::websocket::connection&, const std::string&)> close_handler,
						std::function<void(Module::websocket::connection&)> error_handler,
						std::function<bool(const Module::request&)> accept_handler)
					...
					, accept_handler_(std::move(accept_handler))
				{
                    ...
                    start(Module::utility::base64encode((char*)digest, 20));
				}
