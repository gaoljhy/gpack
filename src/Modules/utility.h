...
#define Module_INTERNAL_PARAMETER_TAG(t, i) \
template <> \
struct parameter_tag<t> \
{ \
    static const int value = i; \
}
        Module_INTERNAL_PARAMETER_TAG(int, 1);
        Module_INTERNAL_PARAMETER_TAG(char, 1);
        Module_INTERNAL_PARAMETER_TAG(short, 1);
        Module_INTERNAL_PARAMETER_TAG(long, 1);
        Module_INTERNAL_PARAMETER_TAG(long long, 1);
        Module_INTERNAL_PARAMETER_TAG(unsigned int, 2);
        Module_INTERNAL_PARAMETER_TAG(unsigned char, 2);
        Module_INTERNAL_PARAMETER_TAG(unsigned short, 2);
        Module_INTERNAL_PARAMETER_TAG(unsigned long, 2);
        Module_INTERNAL_PARAMETER_TAG(unsigned long long, 2);
        Module_INTERNAL_PARAMETER_TAG(double, 3);
        Module_INTERNAL_PARAMETER_TAG(std::string, 4);
#undef Module_INTERNAL_PARAMETER_TAG
...
#define Module_INTERNAL_PROMOTE_TYPE(t1, t2) \
        template<> \
        struct promote<t1> \
        {  \
            using type = t2; \
        ...
        Module_INTERNAL_PROMOTE_TYPE(char, int64_t);
        Module_INTERNAL_PROMOTE_TYPE(short, int64_t);
        Module_INTERNAL_PROMOTE_TYPE(int, int64_t);
        Module_INTERNAL_PROMOTE_TYPE(long, int64_t);
        Module_INTERNAL_PROMOTE_TYPE(long long, int64_t);
        Module_INTERNAL_PROMOTE_TYPE(unsigned char, uint64_t);
        Module_INTERNAL_PROMOTE_TYPE(unsigned short, uint64_t);
        Module_INTERNAL_PROMOTE_TYPE(unsigned int, uint64_t);
        Module_INTERNAL_PROMOTE_TYPE(unsigned long, uint64_t);
        Module_INTERNAL_PROMOTE_TYPE(unsigned long long, uint64_t);
        Module_INTERNAL_PROMOTE_TYPE(float, double);
#undef Module_INTERNAL_PROMOTE_TYPE
